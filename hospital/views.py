...
def patient_signup_view(request):
    ...
    if request.method == 'POST':
        ...
        if userForm.is_valid() and patientForm.is_valid():
            ...
            patient.user = user
            patient.assignedDoctorId = patientForm.cleaned_data['assignedDoctorId'].id
            patient.save()
            ...
            print("❌ Form errors:", userForm.errors, patientForm.errors)
...
def is_patient(user):
    return user.groups.filter(name='PATIENT').exists()and hasattr(user, 'patient') and user.patient.status
